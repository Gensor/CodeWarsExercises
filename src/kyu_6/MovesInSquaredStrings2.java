...
public class MovesInSquaredStrings2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(oper(MovesInSquaredStrings2::selfieAndRot, str));
    ...
    public static String selfieAndRot(String strng) {
        int size =(int) Math.sqrt(strng.replaceAll("\\n","").length());

        String first = Arrays.stream(strng.split("\\n"))
                .map(x -> x+".".repeat(size)+"\n")
                .reduce("", (a,b) -> a+b)
                .replaceAll("$\\n","");
    ...
    public static String oper( Function<String, String> doSomething, String s) {
        return doSomething.apply(s) ;
    }
